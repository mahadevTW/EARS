...
def classify(path):
    ...
    if (accident_detected):
        ...
        # print(newVidName)
        videoPath = '/home/pradnya/Documents/BE_Project_2019/EARS-master/Accident_Detection/Python_Demo/videos/' + newVidName
        shutil.copy(videoPath,
                    '/home/pradnya/Documents/BE_Project_2019/EARS-master/Accident_Detection/Python_Demo/videos-to-show')
        print(files)
        db.insertVideoName(newVidName)
